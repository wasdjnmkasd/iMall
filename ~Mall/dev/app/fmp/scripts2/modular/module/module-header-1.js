...
define(["config.page.render"], function(Render) {
    ...
    return Render.extend({
        ...
        ".component-header-left   .text_mpMall         touchend": function () {
            ...
            if (isLogin) {
                ...
                window.location.href = api.jsUtil.path.setParam(mDomainName, {userId: '0', shopId:shopId, authId: 'noToken', openId: openId});
            }
        },
