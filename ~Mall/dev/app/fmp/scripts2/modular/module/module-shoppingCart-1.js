...
define(["config.page.render"], function(Render) {
    ...
    return Render.extend({
        ...
        ".component-shoppingCart-ordersDetails    .btn_input                    input":    function(node){
            ...
            var itemId = $node.parents("[itemId]").attr("itemId");
            var stock = orders.typeObj[type][supplierId].itemObj[itemId].attr("stock");
            var quantity = orders.typeObj[type][supplierId].itemObj[itemId].attr("quantity");
            var minQuantity = orders.typeObj[type][supplierId].itemObj[itemId].attr("minQuantity");
            var maxQuantity = orders.typeObj[type][supplierId].itemObj[itemId].attr("maxQuantity");
            if((type||type===0) && (supplierId||supplierId===0) && (itemId||itemId===0)){
                ...
                confirmFun: function(){
                    that.sendRequest("ORDER_SHOPPINGCART_DELETE", {
                        ...
                        if(response && response.success){
                            ...
                            that.sendRequest("ORDER_SHOPPINGCART_COUNT", {platformSource: 7})
                                .done(function(response){
                                   if(response && response.success){
        ...
        ".component-shoppingCart-optionsGroup     .btn_commitOrder:not(.lose)   click": function(){
            ...
            $.each(orders.typeObj, function(n1, o1){
                $.each(o1, function(n2, o2){
                    ...
                    var rakebackSupplierPrice = 0;
                    var rakebackSupplierVipPrice = 0;
                    var rakebackSupplierRealPrice = 0;
                    var rakebackSupplierRealVipPrice = 0;
                    $.each(o2.itemObj, function(n3, o3){
                        if(o3.status!==0 && o3.stock > 0 && o3.stock >= o3.minQuantity && o3.selected && o3.quantity>0){
                            ...
                            rakebackSupplierPrice += o3.itemSpecs.welfarePrice * o3.quantity;
                            rakebackSupplierVipPrice += 0 * o3.quantity;
                            rakebackSupplierRealPrice += o3.itemSpecs.welfarePrice * o3.quantity;
                            rakebackSupplierRealVipPrice += 0 * o3.quantity;
                            ...
                            ordersInfo.typeObj[n1][n2].rakebackSupplierPrice = rakebackSupplierPrice*1;
                            ordersInfo.typeObj[n1][n2].rakebackSupplierVipPrice = rakebackSupplierVipPrice*1;
                            ordersInfo.typeObj[n1][n2].rakebackSupplierRealPrice = rakebackSupplierRealPrice*1;
                            ordersInfo.typeObj[n1][n2].rakebackSupplierRealVipPrice = rakebackSupplierRealVipPrice*1;
                            ...
                            ordersInfo.typeObj[n1][n2].itemObj[n3].rakebackPrice = o3.rakebackPrice;
                            ordersInfo.typeObj[n1][n2].itemObj[n3].rakebackVipPrice = o3.rakebackVipPrice;
                            ordersInfo.typeObj[n1][n2].itemObj[n3].rakebackRealPrice = o3.rakebackRealPrice;
                            ordersInfo.typeObj[n1][n2].itemObj[n3].rakebackRealVipPrice = o3.rakebackRealVipPrice;
                ...
                $.each(ordersInfo.typeObj, function(k1,o1){
                    $.each(o1,function(k2,o2){
                        ...
                        $.each(o2.itemObj,function(k3,o3){
                            if(o3.type === 0){
                                crossPrice += o3.rakebackRealPrice * o3.quantity;
                                crossCount += o3.quantity;
                            }else if(o3.type === 2){
                                normalPrice += o3.rakebackRealPrice * o3.quantity;
