                    ...
                    $.each(o1, function(n2, o2){
                        ...
                        $.each(o2.itemObj, function(n3, o3){
                            if(o2.type == 2) {
                                ...
                                that.orders.typeObj[n1][n2].itemObj[n3].attr("rakebackPrice", o3.itemSpecs.welfarePrice);
                                that.orders.typeObj[n1][n2].itemObj[n3].attr("rakebackVipPrice", 0);
                                that.orders.typeObj[n1][n2].itemObj[n3].attr("rakebackRealPrice",o3.itemSpecs.welfarePrice);
                                that.orders.typeObj[n1][n2].itemObj[n3].attr("rakebackRealVipPrice", 0);
                        ...
                        if(n1 == 2){
                            ...
                            that.orders.typeObj[n1][n2].attr("rakebackSupplierPrice",   rakebackSupplierPrice*1);
                            that.orders.typeObj[n1][n2].attr("rakebackSupplierVipPrice",  rakebackSupplierVipPrice*1);
                            that.orders.typeObj[n1][n2].attr("rakebackSupplierRealPrice",  rakebackSupplierRealPrice*1);
                            that.orders.typeObj[n1][n2].attr("rakebackSupplierRealVipPrice",  rakebackSupplierRealVipPrice*1);
                        }
                        orderPrice += rakebackSupplierRealPrice<rakebackSupplierPrice? rakebackSupplierRealPrice: rakebackSupplierPrice;
                    });
                });
